...
module.exports = function() {
	...
	var compile = function(path, callback) {
	...
	var render = function(path, data, callback) {
	...
	// Then pass the template `path` and `data` to `render()`

	var renderFromEndpoint = function(path, dataURI, callback) {

		requestFromEndpoint(dataURI, function(error, response) {

			render(path, response, callback);
